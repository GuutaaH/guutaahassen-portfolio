                ...
                <div className="max-w-5xl mx-auto px-4 flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center">
                        ...
                        <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,2246,0.2)] transition">
                            ...
                            <p className="text-gray-400 mb-4">
                                Developed a website for a local care detailing buissness
                            </p>
                            ...
                            {/* Project Link */}
                            <div className="flex justify-between items-center">
                                <a href="https://autoglow-detailing.vercel.app/" className="text-blue-400 hover:text-blue-300 transition-colors my-4" target="_blank"> 
                                    View Project
                                </a>
                            </div>
                        </div>
